...
object Colors {
    ...
    fun getAverageColor(bi: BufferedImage): Int {
        var sampled = 0
        var redTotal = 0
        var greenTotal = 0
        var blueTotal = 0
        ...
        val averageRed: Int = redTotal / sampled
        val averageGreen: Int = greenTotal / sampled
        val averageBlue: Int = blueTotal / sampled

        val color = Color(averageRed, averageGreen, averageBlue)
