...
const val LOCAL_TILE_SIZE = 1 shl LOCAL_COORD_BITS
const val LOCAL_HALF_TILE_SIZE = LOCAL_TILE_SIZE / 2
const val REGION_X_STRIDE = 256

const val UNIT = Math.PI / 1024.0
val SINE = IntArray(2048) { i -> (65536.0 * sin(i * UNIT)).toInt() }
val COSINE = IntArray(2048) { i -> (65536.0 * cos(i * UNIT)).toInt() }
