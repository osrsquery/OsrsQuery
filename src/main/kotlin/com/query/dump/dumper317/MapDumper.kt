...
object MapDumper {
    ...
    fun init() {
        ...
        val raf = RandomAccessFile(FileUtils.getFile("dump317/","map_index").toPath().toString(), "rw")
        var total = 0
        raf.seek(2L)
        ...
        for (x in 0..255) {
            for (y in 0..255) {
                ...
                if (mapID != -1) {
                    ...
                    if (mapData != null) {
                        gzip(FileUtils.getFile("dump317/index4/", "${mapID}.gz"),mapData)
                    } else {
                ...
                if (landscapeID != -1) {
                    ...
                    if (keys != null) {
                        ...
                        if (landscapeData != null) {
                            gzip(FileUtils.getFile("dump317/index4/", "${mapID}.gz"), landscapeData)
                        } else {
                            failedMaps[regionId] = Pair(mapID, landscapeID)
                        }
                    } else {
